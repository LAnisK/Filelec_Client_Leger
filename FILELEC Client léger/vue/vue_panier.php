...
<body>
    ...
    <?php else: ?>
        ...
        <div class="panier">
            <?php foreach ($panier as $item): ?>
                ...
                <div class="panier-item">
                    <div class="panier-item-info">
                        ...
                        <form method="post">
                        <p>Quantité : <input type="text" name="qte" value="<?= htmlspecialchars($item['quantite']) ?>" >
            ...
            <div class="panier-total">
                ...
                <form action="achPanier" method="post">
                    <a href="index.php?page=12">Acheter</a>
                </form>
    ...
    <a href="index.php?page=9" class="retour-catalogue">Retour au catalogue</a>
</body>
</html>